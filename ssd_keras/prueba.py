...
if __name__ == '__main__':
	...
	aspect_ratios = [0.5, 1.0, 2.0]  # The anchor box aspect ratios used in the original SSD300; the order matters
	...
	plt.figure()
        ...
        plt.savefig('Accuracy_ssd7_1000.jpg')
        ...
        plt.xlabel('Epoch')
        plt.legend(['train', 'test'], loc='upper left')
        plt.savefig('Loss_ssd7_1000.jpg')
