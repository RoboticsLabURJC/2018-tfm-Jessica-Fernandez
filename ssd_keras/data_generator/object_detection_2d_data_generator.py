...
class DataGenerator:
    ...
    def parse_xml(self,
            ...
            for image_id in it:
                ...
                if not annotations_dir is None:
                    ...
                    for obj in objects:
                        ...
                        if (class_name == 'small-truck'):
                            num_small_truck = num_small_truck + 1
                        if (class_name == 'tank-truck'):
                            num_tank_truck = num_tank_truck + 1
        ...
        if ret:
            ...
            return num_car,num_motorcycle,num_van,num_bus,num_truck,num_small_truck,num_tank_truck
