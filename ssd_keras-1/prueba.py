...
if __name__ == '__main__':
	...
	images_dir      = '/home/vanejessi/Etiquetado de imagenes/smart-traffic-sensor-lab/vehicles-dataset/images/'

	# The directories that contain the annotations.
	annotations_dir      = '/home/vanejessi/Etiquetado de imagenes/smart-traffic-sensor-lab/vehicles-dataset/annotations/'

	# The paths to the image sets.
	train_image_set_filename    = '/home/vanejessi/ssd_keras-1/train.txt'
	test_image_set_filename      = '/home/vanejessi/ssd_keras-1/test.txt'

	classes = ['car','motorcycle', 'van', 'bus', 'truck',
		   'small-truck', 'tank-truck']

	train_dataset = BatchGenerator(box_output_format=['class_id', 'xmin', 'xmax', 'ymin', 'ymax'])

	train_dataset.parse_xml(images_paths=[images_dir],
		                annotations_paths=[annotations_dir],
		                image_set_paths=[train_image_set_filename],
		                classes=classes,
		                include_classes='all',
	...
	val_dataset.parse_xml(images_paths=[images_dir],
		              annotations_paths=[annotations_dir],
		              image_set_paths=[test_image_set_filename],
		              classes=classes,
		              include_classes='all',
		              exclude_truncated=False,
		              exclude_difficult=False,
