...
\makeglossaries
\input{capitulos/0-Acronimos} % Archivo que contiene los acrónimos
...
\include{capitulos/2-Estado_arte}
\lhead[]{CAPÍTULO \thechapter. HERRAMIENTAS}
\include{capitulos/3-Herramientas}
\lhead[]{CAPÍTULO \thechapter. DISEÑO GLOBAL DEL SISTEMA}
\include{capitulos/4-Diseno_global}
\lhead[]{CAPÍTULO \thechapter. EXPERIMENTOS}
\include{capitulos/5-Experimentos}
\lhead[]{CAPÍTULO \thechapter. CONCLUSIONES}
\include{capitulos/6-Conclusiones}
