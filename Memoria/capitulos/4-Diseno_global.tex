...
La red Yolov3 está formada por un total de 106 capas,  las cuales se pueden agrupar en dos grupos, uno encargado de la extracción de características y otro de la detección de objetos:

\begin{itemize}
    \item Extracción de características (de la capa 1 a la 74): se trata de la red Darknet-53 entrenada con ImageNet, la cual se compone de 53 capas convolucionales (Figura~\ref{fig.darknet53}).
    \begin{figure}[H] 
\begin{center}
...
\end{figure}
    ...
    \item Detección de Objetos (de la capa 75 a la 106): toma como entrada las características 3D (13x13x1024) y realiza con ello la detección de objetos. La singularidad de esta red reside en su capacidad para lograr detectar objetos en tres escalas diferentes, haciendo de ella una red muy potente ante el cambio de escala. Para ello extrae características en tres escalas diferentes (13x13x42, 26x26x42 y 52x52x42). Estas características pasan a la capa final YOLO, que clasifica la etiqueta del objeto con regresiones logísticas de clase y localiza los objetos con regresores de \textit{bounding boxes}.
