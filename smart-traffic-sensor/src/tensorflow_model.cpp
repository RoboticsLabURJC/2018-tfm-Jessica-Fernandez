...
#include "/usr/local/cuda-9.2/include/cuda_runtime_api.h"
#include "/usr/local/cuda-9.2/include/cuda_runtime.h"
#include <stdio.h>
...
void TensorflowModel::end_session()
{
      /*int *a, *b, *c;
      int *gpu_a, *gpu_b, *gpu_c;
 
      a = (int *)malloc(65535 * sizeof(int));
    //printf("End session \n");
    PyObject* conf = PyFloat_FromDouble(1.0);
	...
	//pValue = PyObject_CallObject(pFunc, pArgs);
	pValue = PyObject_CallMethodObjArgs(pInstance, PyString_FromString("end"), conf, NULL);
