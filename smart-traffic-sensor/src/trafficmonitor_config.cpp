...
const string CONTROL_CNN_TRACKING              = prefix+"Control.cnnTrackingActive";
const string CONTROL_KERAS_TRACKING            = prefix+"Control.kerasTrackingActive";
const string CONTROL_DARKNET_TRACKING          = prefix+"Control.darknetTrackingActive";
...
const string GLADE_FILE_NAME                   = prefix+"gladeFileName";
  ...
  void TrafficMonitorAlgorithmConfig::loadConfiguration()
  {
    ...
    cnnTrackingActive        = stoi(cfg[CONTROL_CNN_TRACKING]);
    kerasTrackingActive      = stoi(cfg[CONTROL_KERAS_TRACKING]);
    darknetTrackingActive    = stoi(cfg[CONTROL_DARKNET_TRACKING]);
...
string TrafficMonitorAlgorithmConfig::dump() const
{
   ...
   ss << MAX_VEHICLES                        << "=" << max_vehicles               << endl
      ...
      << CONTROL_CNN_TRACKING                << "=" << cnnTrackingActive          << endl
      << CONTROL_KERAS_TRACKING              << "=" << kerasTrackingActive        << endl
      << CONTROL_DARKNET_TRACKING            << "=" << darknetTrackingActive      << endl
