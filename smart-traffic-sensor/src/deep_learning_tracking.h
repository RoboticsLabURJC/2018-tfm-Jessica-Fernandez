 ...
 *
 */
#ifndef _DEEP_LEARNING_TRACKER_
#define _DEEP_LEARNING_TRACKER_
...
class DeepLearningTracker: public CSingleton<DeepLearningTracker>{
...
public:
    ...
    */
  void track_blobs_deep_learning(colorspaces::Image& new_frame,
                   timeval timestamp,
                   vector<Blob*>& tracked_blobs,
                   vector<Blob*>& tmp_blobs,
                   unsigned int num_blobs);
   void track_blobs_klt(colorspaces::Image& new_frame
                                   ,timeval timestamp
                                   ,vector<Blob*>& tracked_blobs
                                   ,unsigned int num_blobs);
   /**
...
protected:
   ...
   friend class CSingleton<DeepLearningTracker>;
...
private:
   ...
   bool match_blob_using_klt_prueba(Blob* blob, unsigned int num_blobs, Blob* matched_blob);
   void get_good_features(IplImage* grey, Blob* blob);
   void get_uniform_points(Blob* blob);
   bool match_blob_deep_learning(Blob* blob, vector<Blob*>& tmp_blobs, unsigned int num_blobs, Blob* matched_blob);
   bool match_blob_using_distance_deep_learning(Blob* blob, vector<Blob*>& tmp_blobs, unsigned int num_blobs, Blob* matched_blob);
